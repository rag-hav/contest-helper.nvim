...
---@field tests ExtensionDataTestCase[] An array of objects containing testcase data. The JSON objects in the array all have two keys: input and output. Both the input and the output need to end with a newline character.
---@field testType ExtesionDataTestType The type of the tests.
---@field input ExtensionDataInputType An object which is used to configure how to receive input.
---@field output ExtensionDataOutputType An object which is used to configure how to send output.
---@field languages ExtensionDataLanguage An object with language specific settings.
---@field batch ExtensionDataBatch An object containing information about the batch of problems that this problem belongs to. Required options:

---@class ExtensionDataTestCase
---@field input string
---@field output string

---@alias ExtesionDataTestType
---| '"single"'  The left side of the device
---| '"multiNumber"'  The right side of the device

---@class ExtensionDataInputType
---@field type ExtesionDataInputTypeType
---@field pattern? string
---@field fileName? string

---@alias ExtesionDataInputTypeType
...
---@class ExtensionDataOutputType
---@field type ExtesionDataOutputTypeType
---@field fileName? string

---@alias ExtesionDataOutputTypeType
...
---@class ExtensionDataLanguage
---@field java ExtensionDataLanguageJava An object with Java specific settings

---@class ExtensionDataLanguageJava
...
---@field trimPreceedingWhitespaces boolean
